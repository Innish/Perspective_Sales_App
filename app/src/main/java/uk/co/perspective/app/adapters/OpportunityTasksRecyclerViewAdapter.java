...
public class OpportunityTasksRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final List<JoinOpportunityTask> dataList;
    private Context context;
    private int rowIndex;

    RecyclerView mRecyclerView;

    OpportunityTasksRecyclerViewAdapter.TaskListener mListener;
    ...
    public OpportunityTasksRecyclerViewAdapter(List<JoinOpportunityTask> dataList, FragmentManager fragmentManager, Context context, TaskListener listener){
                    ...
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            DatabaseClient.getInstance(context).getAppDatabase()
                                    .opportunityDao()
                                    .deleteOpportunityTask(dataList.get(position).getId(), dataList.get(position).getLocalOpportunityID());
    ...
    public static class RecordViewHolder extends RecyclerView.ViewHolder {
        ...
        public JoinOpportunityTask mItem;
