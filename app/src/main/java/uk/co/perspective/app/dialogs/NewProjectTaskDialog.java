...
public class NewProjectTaskDialog extends DialogFragment implements ChangeCustomerDialog.ChangeCustomerListener, NewProjectPhaseDialog.NewProjectPhaseListener {
    ...
    NewProjectTaskDialog.NewTaskListener mListener;
    ...
    public static NewProjectTaskDialog newInstance(NewTaskListener mListener, int localProjectID) {
        NewProjectTaskDialog frag = new NewProjectTaskDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.dialog_new_project_task, container, false);
        ...
        addProjectPhase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NewProjectPhaseDialog newFragment = NewProjectPhaseDialog.newInstance(NewProjectTaskDialog.this, localProjectID);
        ...
        customerLookup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ChangeCustomerDialog newFragment = ChangeCustomerDialog.newInstance(NewProjectTaskDialog.this);
