...
public class EditOrderLineDialog extends DialogFragment implements ChangeProductDialog.ChangeProductListener {
    ...
    EditOrderLineDialog.UpdatedOrderLineListener mListener;

    public interface UpdatedOrderLineListener {
        public void UpdatedOrderLine(int position, OrderLine updatedLine);
        public void RemoveOrderLine(int position, OrderLine removedLine);
    }

    public EditOrderLineDialog() {
        // Required empty public constructor
    }

    public void setListener(UpdatedOrderLineListener listener) {
        mListener = listener;
    }

    public void setOrderLine(int position, OrderLine line) {
        thisLine = line;
        Position = position;
    }

    public static EditOrderLineDialog newInstance(UpdatedOrderLineListener mListener, int Position, OrderLine Line) {
        EditOrderLineDialog frag = new EditOrderLineDialog();
        Bundle args = new Bundle();
        frag.setListener(mListener);
        frag.setOrderLine(Position, Line);
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.dialog_edit_order_line, container, false);
        ...
        productLookup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ChangeProductDialog newFragment = ChangeProductDialog.newInstance(EditOrderLineDialog.this);
        ...
        okSelected.setOnClickListener(new View.OnClickListener() {
            ...
            if (!description.getText().toString().equals("")) {
                ...
                mListener.UpdatedOrderLine(Position, thisLine);
                ...
                new AlertDialog.Builder(requireContext())
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (mListener != null) {
                                    mListener.RemoveOrderLine(Position, thisLine);
                                    dismiss();
                                }
