...
public class NewQuoteLineDialog extends DialogFragment implements ChangeProductDialog.ChangeProductListener {
    ...
    NewQuoteLineDialog.NewQuoteLineListener mListener;

    public interface NewQuoteLineListener {
        public void NewQuoteLineAdded(QuoteLine quoteLine);
    }

    public NewQuoteLineDialog() {
        // Required empty public constructor
    }

    public void setListener(NewQuoteLineListener listener) {
        mListener = listener;
    }

    public void setQuoteID(int localQuoteID) {
        LocalQuoteID = localQuoteID;
    }

    public static NewQuoteLineDialog newInstance(NewQuoteLineListener mListener, int localQuoteID) {
        NewQuoteLineDialog frag = new NewQuoteLineDialog();
        Bundle args = new Bundle();
        frag.setListener(mListener);
        frag.setQuoteID(localQuoteID);
        return frag;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.dialog_new_quote_line, container, false);
        ...
        productLookup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ChangeProductDialog newFragment = ChangeProductDialog.newInstance(NewQuoteLineDialog.this);
        ...
        okSelected.setOnClickListener(new View.OnClickListener() {
            ...
            if (!description.getText().toString().equals("")) {
                ...
                QuoteLine thisLine = new QuoteLine();

                thisLine.setLocalQuoteID(LocalQuoteID);
                ...
                mListener.NewQuoteLineAdded(thisLine);
