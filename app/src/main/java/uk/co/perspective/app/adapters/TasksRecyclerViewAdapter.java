...
import uk.co.perspective.app.entities.*;
import uk.co.perspective.app.helpers.TaskDiffCallback;
...
public class TasksRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    TasksRecyclerViewAdapter.TaskListener mListener;
    ...
    public TasksRecyclerViewAdapter(List<Task> dataList, FragmentManager fragmentManager, Context context, TaskListener listener){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (viewHolder.getItemViewType() == 1) {
            ...
            if (dataList.get(position).getTaskID() != null) {
                holder.thisTaskID = dataList.get(position).getTaskID();
            } else {
                holder.thisTaskID = 0;
            }
