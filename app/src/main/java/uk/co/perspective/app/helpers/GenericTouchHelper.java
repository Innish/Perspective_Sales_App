...
public class GenericTouchHelper extends ItemTouchHelper.Callback {
    ...
    public GenericTouchHelper(ItemTouchHelperAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder instanceof OpportunityContactsRecyclerViewAdapter.AddRecordViewHolder)
        {
            return 0;
        }
        else if (viewHolder instanceof OpportunityQuotesRecyclerViewAdapter.AddRecordViewHolder)
        {
            return 0;
        }
