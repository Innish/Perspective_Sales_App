...
public class QuoteLineTouchHelper extends ItemTouchHelper.Callback {

    public static final float ALPHA_FULL = 1.0f;

    private final ItemTouchHelperAdapter mAdapter;

    public QuoteLineTouchHelper(ItemTouchHelperAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder instanceof QuoteLinesRecyclerViewAdapter.AddRecordViewHolder)
        {
            return 0;
        }
