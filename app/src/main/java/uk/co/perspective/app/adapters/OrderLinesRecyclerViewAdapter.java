...
public class OrderLinesRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchHelperAdapter {

    private final List<OrderLine> dataList;
    ...
    OrderLinesRecyclerViewAdapter.OrderListener mListener;
    ...
    public OrderLinesRecyclerViewAdapter(List<OrderLine> dataList, String currency, float exchangeRate, FragmentManager fragmentManager, Context context, OrderListener listener){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (viewHolder.getItemViewType() == 1) {
            ...
            if (dataList.get(position).getOrderLineID() != null) {
                holder.thisOrderLineID = dataList.get(position).getOrderLineID();
            } else {
                holder.thisOrderLineID = 0;
            }
    ...
    public static class RecordViewHolder extends RecyclerView.ViewHolder implements ItemTouchHelperViewHolder {
        ...
        public OrderLine mItem;
        public int thisOrderLineID;
