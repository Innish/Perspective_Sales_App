 ...
 * Use the {@link FilterOpportunitiesDialog#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FilterOpportunitiesDialog extends DialogFragment implements FilterStatusDialog.SetFilterListener {
    ...
    FilterOpportunitiesDialog.SetFilterListener mListener;
    ...
    public FilterOpportunitiesDialog() {
        // Required empty public constructor
    }

    public static FilterOpportunitiesDialog newInstance(SetFilterListener mListener) {
        FilterOpportunitiesDialog fragment = new FilterOpportunitiesDialog();
        fragment.setListener(mListener);
        return fragment;
    }

    public void setListener(FilterOpportunitiesDialog.SetFilterListener listener) {
        mListener = listener;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String filterSelection = sharedPreferences.getString("opportunity_filter_selection", "Everything");
        ...
        applyFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("opportunity_filter_selection", radioFilterButton.getText().toString());
                editor.apply();
    ...
    public void SetByStatusFilter()
    {
        ...
        opportunityStatus.add("Qualification");
        opportunityStatus.add("Needs Analysis");
        opportunityStatus.add("Proposal/Quote");
        opportunityStatus.add("Negotiation/Review");
        opportunityStatus.add("Follow-Up");
        opportunityStatus.add("Closed Won");
        opportunityStatus.add("Closed Lost");

        FragmentManager fm = getChildFragmentManager();
        FilterStatusDialog newFragment = FilterStatusDialog.newInstance(FilterOpportunitiesDialog.this, opportunityStatus);
