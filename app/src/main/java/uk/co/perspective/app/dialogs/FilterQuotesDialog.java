 ...
 * Use the {@link FilterQuotesDialog#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FilterQuotesDialog extends DialogFragment implements FilterStatusDialog.SetFilterListener {
    ...
    FilterQuotesDialog.SetFilterListener mListener;
    ...
    public FilterQuotesDialog() {
        // Required empty public constructor
    }

    public static FilterQuotesDialog newInstance(SetFilterListener mListener) {
        FilterQuotesDialog fragment = new FilterQuotesDialog();
        fragment.setListener(mListener);
        return fragment;
    }

    public void setListener(FilterQuotesDialog.SetFilterListener listener) {
        mListener = listener;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String filterSelection = sharedPreferences.getString("quote_filter_selection", "Everything");
        ...
        applyFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("quote_filter_selection", radioFilterButton.getText().toString());
                editor.apply();
    ...
    public void SetByStatusFilter()
    {
        ...
        opportunityStatus.add("Issued");
        opportunityStatus.add("Under Review");
        opportunityStatus.add("Accepted");
        opportunityStatus.add("Rejected");

        FragmentManager fm = getChildFragmentManager();
        FilterStatusDialog newFragment = FilterStatusDialog.newInstance(FilterQuotesDialog.this, opportunityStatus);
