 ...
 * Use the {@link FilterProjectsDialog#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FilterProjectsDialog extends DialogFragment implements FilterStatusDialog.SetFilterListener {
    ...
    FilterProjectsDialog.SetFilterListener mListener;
    ...
    public FilterProjectsDialog() {
        // Required empty public constructor
    }

    public static FilterProjectsDialog newInstance(SetFilterListener mListener) {
        FilterProjectsDialog fragment = new FilterProjectsDialog();
        fragment.setListener(mListener);
        return fragment;
    }

    public void setListener(FilterProjectsDialog.SetFilterListener listener) {
        mListener = listener;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String filterSelection = sharedPreferences.getString("project_filter_selection", "Everything");
        ...
        applyFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("project_filter_selection", radioFilterButton.getText().toString());
                editor.apply();
    ...
    public void SetByStatusFilter()
    {
        ...
        projectStatus.add("New");
        projectStatus.add("Planning");
        projectStatus.add("Active");
        projectStatus.add("On Hold");
        projectStatus.add("Cancelled");
        projectStatus.add("Closed");

        FragmentManager fm = getChildFragmentManager();
        FilterStatusDialog newFragment = FilterStatusDialog.newInstance(FilterProjectsDialog.this, projectStatus);
