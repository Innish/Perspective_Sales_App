...
public class OrderLineTouchHelper extends ItemTouchHelper.Callback {

    public static final float ALPHA_FULL = 1.0f;

    private final ItemTouchHelperAdapter mAdapter;

    public OrderLineTouchHelper(ItemTouchHelperAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder instanceof OrderLinesRecyclerViewAdapter.AddRecordViewHolder)
        {
            return 0;
        }
